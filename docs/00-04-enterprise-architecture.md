...
I designed the fictional company environment before deploying infrastructure. In this chapter I defined the company structure, core systems, network zones, naming conventions, VM sizing, and the initial logical topology that later chapters will implement.
